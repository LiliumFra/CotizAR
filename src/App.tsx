                ...
                <div className="max-w-[1400px] mx-auto px-4 md:px-6 h-16 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                         ...
                         <div className="flex items-center gap-3 sm:gap-4">
                             {/* Dolar Blue Compra Clickable Stat */}
                             <button 
                                onClick={() => {
                             ...
                             >
                                <span className="text-[9px] uppercase font-bold text-slate-500 group-hover:text-emerald-400 transition-colors flex items-center gap-1">
                                    Blue Compra
                                </span>
                                <span className="text-xs font-mono font-bold text-white bg-slate-800 group-hover:bg-slate-700 px-2 py-0.5 rounded border border-slate-700 group-hover:border-emerald-500/30 transition-all">
                                    ${blueRate.compra}
                                </span>
                             </button>
                             ...
                             {/* Dolar Blue Venta Clickable Stat */}
                             <button 
                                onClick={() => {
                                    setSelectedType('blue');
                                    setActiveTab('home');
